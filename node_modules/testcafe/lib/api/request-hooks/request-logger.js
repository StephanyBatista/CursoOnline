...
var RequestLoggerImplementation = function (_RequestHook) {
    (0, _inherits3.default)(RequestLoggerImplementation, _RequestHook);

    function RequestLoggerImplementation(requestFilterRuleInit, options) {
        (0, _classCallCheck3.default)(this, RequestLoggerImplementation);
    ...
    RequestLoggerImplementation._assertLogOptions = function _assertLogOptions(logOptions) {
    ...
    RequestLoggerImplementation.prototype.onRequest = function onRequest(event) {
    ...
    RequestLoggerImplementation.prototype.onResponse = function onResponse(event) {
    ...
    RequestLoggerImplementation.prototype._prepareInternalRequestInfo = function _prepareInternalRequestInfo() {
    ...
    RequestLoggerImplementation.prototype._getCompletedRequests = function _getCompletedRequests() {
    ...
    RequestLoggerImplementation.prototype.contains = function contains(predicate) {
        var _this2 = this;
    ...
    RequestLoggerImplementation.prototype.count = function count(predicate) {
        var _this3 = this;
    ...
    RequestLoggerImplementation.prototype.clear = function clear() {
        var _this4 = this;
    ...
    (0, _createClass3.default)(RequestLoggerImplementation, [{
        key: 'requests',
        get: function get() {
            return this._prepareInternalRequestInfo();
        }
    }]);
    return RequestLoggerImplementation;
}(_hook2.default);
