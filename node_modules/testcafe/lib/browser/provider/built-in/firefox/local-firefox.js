...
var start = exports.start = function () {
    var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(pageUrl, runtimeInfo) {
        var browserName, config, firefoxInfo, firefoxOpenParameters;
        return _regenerator2.default.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        browserName = runtimeInfo.browserName, config = runtimeInfo.config;
                        _context.next = 3;
...
function buildFirefoxArgs(config, platformArgs, _ref) {
    var marionettePort = _ref.marionettePort,
        tempProfileDir = _ref.tempProfileDir;
